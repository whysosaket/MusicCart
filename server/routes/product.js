const { addProduct, addToCart, removeFromCart, getCart, checkout  } = require("../controllers/productController");
...
const product = (router) => {
  ...
  router.route("/api/product/removefromcart").post(fetchuser, (req, res) => removeFromCart(req, res));
